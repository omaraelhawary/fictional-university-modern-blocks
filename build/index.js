...
class Like {
  ...
  async createLike(clickedElement) {
    try {
      const response = await axios__WEBPACK_IMPORTED_MODULE_0__["default"].post(uniData.root_url + "/wp-json/university/v1/manageLike", {
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkfictional_university_fse"] = self["webpackChunkfictional_university_fse"] || [];
