...
function Edit(props) {
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.useEffect)(function () {
    if (!props.attributes.imageURL) {
      props.setAttributes({
        imageURL: ourThemeData.themePath + "/images/library-hero.jpg"
      });
    }
  }, []);
...
module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"ourblocktheme/slide","title":"Slide","supports":{"align":["full"]},"attributes":{"align":{"type":"string","default":"full"},"imageID":{"type":"number"},"imageURL":{"type":"string"}},"editorScript":"file:./index.js","render":"file:./render.php"}');
